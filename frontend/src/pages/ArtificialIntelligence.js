    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50 dark:from-gray-900 dark:via-purple-900/20 dark:to-blue-900/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <motion.div
          ...
          className="rounded-lg shadow-lg p-8 mb-8 bg-gradient-to-r from-purple-500 via-blue-500 to-indigo-500 text-white relative overflow-hidden"
        >
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
            ...
            <div className="flex flex-wrap gap-3 mt-4 md:mt-0">
              ...
              <span className="px-4 py-1 rounded-full bg-white bg-opacity-20 text-white font-semibold text-sm border border-white/30">
                <FaFileAlt className="inline mr-1" /> Artificial Intelligence
              </span>
            </div>
          </div>
